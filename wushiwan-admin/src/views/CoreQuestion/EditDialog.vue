    ...
    <el-dialog ref="dialogView" :close-on-click-modal="false" :title="getDialogTitle()" :visible.sync="isEditDialogShow" width="35%" height="300px"
      ...
      <el-form :model="dialogModal" ref="dialogForm" :rules="dialogRules" label-position="left" label-width="80px"
        ...
        <el-form-item label="内容" prop="msg">
          <el-input v-model="dialogModal.msg"/>
        </el-form-item>
...
<script>
  import { COREQUESTION_ADD_URL, COREQUESTION_EDIT_URL } from "@/config/host"
    ...
    methods: {
      ...
      onConfirmButtonPressed () {
        ...
        this.$refs.dialogForm.validate((valid) => {
          if (valid) {
          const url = this.dialogModal.id ? COREQUESTION_EDIT_URL : COREQUESTION_ADD_URL
